...
def visualize_heatmap(model, args):
    ...
    with torch.no_grad():
        y = model.module.forward_features(img_tensor)
...
def visualize_dino_attention(model, args):
    ...
    with torch.no_grad():
        attentions = model.module.get_last_selfattention(img_tensor.cuda())
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pp', '--pretrained-path', type=str, default='../pass_vit_small_full.pth')
